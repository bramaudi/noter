...
import { notesFetchAll } from '../models/notes-dummy'
// Components
...
const FeatureCheck = ({ tips, children }) => {
	return (
...
const LandingPage = () => {
	...
	return (
		<>
			{/* Ranomize */}
			<div className="p-5 sm:p-10 h-60 overflow-hidden bg-gradient-to-t from-white to-green-700">
